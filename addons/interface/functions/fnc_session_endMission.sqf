...
params ["_session", "_armaSession", "_missionName", "_worldName", "_startingOrbat", "_finalOrbat"];

(EXTENSION callExtension ["backend:session:finish_mission", [_session, _armaSession, _missionName, _worldName, _startingOrbat, _finalOrbat]]) params ["_result", "_returnCode", "_errorCode"];
